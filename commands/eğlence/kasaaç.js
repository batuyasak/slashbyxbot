...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('kasaaç')
    .setDescription('Kasa açarsın.'),
  async execute (interaction) {
    let csgopng = "https://cdn.discordapp.com/attachments/806245388515410032/830509722418282566/cases.png"
    var kasadancikanlar = [
    ...
    .setImage(csgopng)
    .setAuthor(`Kasayı açan ${interaction.user.tag}`, interaction.user.avatarURL)
